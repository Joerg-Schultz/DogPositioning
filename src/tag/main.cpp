// modified from https://github.com/jremington/UWB-Indoor-Localization_Arduino/blob/main/ESP32_UWB_tag2D_3A/ESP32_UWB_tag2D_3A.ino
#include <Arduino.h>
...
void newRange()
{
    ...
    index++; //TODO Adapt anchor addresses
